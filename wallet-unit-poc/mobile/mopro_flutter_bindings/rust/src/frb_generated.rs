...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1161839864;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        4 => wire__openac_mobile_app__generate_show_input_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__openac_mobile_app__get_comm_w_shared_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__openac_mobile_app__init_app_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__openac_mobile_app__mopro_hello_world_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__openac_mobile_app__prove_prepare_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__openac_mobile_app__prove_show_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__openac_mobile_app__reblind_prepare_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__openac_mobile_app__reblind_show_impl(port, ptr, rust_vec_len, data_len),
        12 => {
            wire__openac_mobile_app__run_complete_benchmark_impl(port, ptr, rust_vec_len, data_len)
        }
        13 => wire__openac_mobile_app__setup_prepare_keys_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__openac_mobile_app__setup_show_keys_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__openac_mobile_app__verify_prepare_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__openac_mobile_app__verify_show_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
